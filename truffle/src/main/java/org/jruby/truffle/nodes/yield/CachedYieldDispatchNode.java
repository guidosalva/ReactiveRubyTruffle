...
public class CachedYieldDispatchNode extends YieldDispatchNode {
    ...
    public Object dispatchWithSelfAndBlock(VirtualFrame frame, RubyBasicObject block, Object self, RubyBasicObject modifiedBlock,BehaviorObject signal, Object... argumentsObjects) {
        ...
        if (guard(block)) {
            return callNode.call(frame, RubyArguments.pack(ProcNodes.getMethod(block), ProcNodes.getDeclarationFrame(block), self, modifiedBlock ,signal, argumentsObjects));
        } else {
